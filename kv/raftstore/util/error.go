...
// ErrNotLeader the raft command
// is proposed on a follower.
// so use it to let the client try other peers.
// project 2b
...
// ErrStaleCommand :It may due to leader changes
// that some logs are not committed and overrided
// with new leaders’ logs. But the client does not know that
// and is still waiting for the response.
// So you should return this to let the client knows
// and retries the command again.
// project 2b
