package engine_util
//iterators for CFItem,Badger,DB,etc
import (
	"github.com/Connor1996/badger"
)

// CFItem implements DBItem
type CFItem struct {
	item      *badger.Item
	prefixLen int
}
...
// BadgerIterator implements DBIterator
type BadgerIterator struct {
	iter   *badger.Iterator
	prefix string //the prefix to be looked up
}
...
func (it *BadgerIterator) Item() DBItem {
	return &CFItem{
		item:      it.iter.Item(), //the current k-v pair
